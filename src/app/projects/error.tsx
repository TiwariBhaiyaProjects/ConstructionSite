"use client";
// RESPONSIBILITY: Module-scoped Error Boundary for the Projects page. Catches rendering crashes and shows a branded retry UI.
...
export default function ProjectsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 bg-background text-center">
      ...
      <h2 className="text-2xl font-bold mb-3">Projects Page Error</h2>
      <p className="text-muted-foreground mb-6 max-w-md">
        We could not load the Projects page content. Our team has been notified.
      </p>
