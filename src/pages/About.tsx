      ...
      <section className="py-24 bg-white border-t border-gray-100" id="contact">
        <div className="container-custom max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-2 text-[#0A1428]">Contact Us</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-[#F8F6F0] border-none shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <CardContent className="p-8 text-center flex flex-col items-center">
                <div className="w-16 h-16 bg-[#E8B923]/20 text-[#E8B923] rounded-full flex items-center justify-center mb-6">
                  <Phone className="w-8 h-8" />
                </div>
                <h3 className="text-xl font-bold text-[#0A1428] mb-2">Call Us</h3>
                <p className="text-gray-600 mb-4">Mon-Sat, 8am to 7pm</p>
                <a href={`tel:${companyInfo.phone}`} className="text-[#E8B923] font-bold text-lg hover:underline">{companyInfo.phone}</a>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#F8F6F0] border-none shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <CardContent className="p-8 text-center flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold text-[#0A1428] mb-2">Email Us</h3>
                <p className="text-gray-600 mb-4">Drop us a line anytime</p>
                <a href={`mailto:${companyInfo.email}`} className="text-[#E8B923] font-bold text-lg hover:underline">{companyInfo.email}</a>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#F8F6F0] border-none shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <CardContent className="p-8 text-center flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold text-[#0A1428] mb-2">Visit Office</h3>
                <p className="text-gray-600 mb-4 text-sm">{companyInfo.address}</p>
                <a href="#" className="text-[#E8B923] font-bold hover:underline">Get Directions</a>
              </CardContent>
            </Card>
          </div>
        </div>
